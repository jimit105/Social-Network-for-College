...
<form action="EditProfileServlet" method="post">           <!-- Put Servlet File Name Here -->
          <fieldset>
            <legend>Personal information:</legend>
            First name:<br>
            <input id="firstname" type="text" name="firstname" required="required"  value="<%=s.getFirstname() %> ">
            <br>

            Last name:<br>
            <input id="lastname" type="text" name="lastname" required="required"  value="<%=s.getLastname() %>"     >
            <br>
            ...
            Password:<br>
            <input id="password" type="password" name="password" required="required"  value="<%=s.getPassword() %>"  >
            <br>
